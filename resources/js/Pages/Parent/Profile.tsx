                ...
                <div className="flex-1 max-w-3xl space-y-8 mt-4 md:mt-0 md:ml-4">
                        ...
                        <form className="space-y-4 relative z-10">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        className="w-full bg-[#FFFFFF] border border-[#E2E8F0] rounded-lg px-4 py-2 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary font-body-md text-body-md text-on-surface transition-colors bg-surface-container-low"
                                        type="text"
                                        value={user.name}
                                        readOnly
                                    />
                    ...
                    <section className="bg-[#FFFFFF] rounded-[16px] border border-[#E2E8F0] shadow-sm p-6 transition-shadow hover:shadow-[0_4px_12px_rgba(6,78,59,0.05)] mb-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center justify-between py-2">
                                ...
                                <button className="px-4 py-2 border border-primary text-primary rounded-lg font-label-md text-label-md hover:bg-primary-container hover:text-on-primary-container transition-colors">
                                    Update
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="flex justify-center mt-8">
                        <Link
                            ...
                            method="post"
                            as="button"
                            className="w-full flex justify-center items-center gap-3 bg-error-container text-error px-6 py-4 rounded-xl font-headline-md hover:opacity-90 transition-opacity"
                        >
                            <span className="material-symbols-outlined">
                                logout
                            </span>
